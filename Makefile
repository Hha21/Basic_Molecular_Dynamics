...
# SRC
SRCS_COMMON = $(wildcard $(SRC_DIR)/*.cpp $(SRC_DIR)/*.cu)
SRCS_PAR = $(filter-out $(SRC_DIR)/SolverSerial.cpp $(SRC_DIR)/SolverSerial.h $(SRC_DIR)/Unit_Tests.cpp $(SRC_DIR)/Unit_Tests_Par.cpp $(SRC_DIR)/main.cpp $(SRC_DIR)/SolverSerialCUDA.cu, $(SRCS_COMMON))
SRCS_SERIAL = $(filter-out $(SRC_DIR)/Solver.cpp $(SRC_DIR)/Solver.h $(SRC_DIR)/Unit_Tests.cpp $(SRC_DIR)/Unit_Tests_Par.cpp $(SRC_DIR)/main.cpp $(SRC_DIR)/SolverSerialCUDA.cu, $(SRCS_COMMON))
SRCS_CUDA = $(filter-out $(SRC_DIR)/Solver.cpp $(SRC_DIR)/SolverSerial.cpp $(SRC_DIR)/Unit_Tests.cpp $(SRC_DIR)/Unit_Tests_Par.cpp $(SRC_DIR)/main.cpp, $(SRCS_COMMON))
...
run-tests: $(TEST_PAR) $(TEST_SERIAL)
	$(TEST_PAR)
	$(TEST_SERIAL)
